...
// Data skill kamu (dikonversi ke format progress bar)
const listSkill = [
  ...
  new Keahlian('Public Speaking', 85),
];
...
// ==========================================
// PORTFOLIO DATA (6 Proyek) - SUDAH DIPERBAIKI
// ==========================================
const projects = [
    
    {
        id: 1,
        title: "Praktikum 2 - Portofolio CSS & JS",
        category: "web",
        image: "assets/images/projects/Portofolio Dasar.png",
    ...
    },
    {
        ...
        category: "web",
        image: "assets/images/projects/jsx attribute children attributes.png",
    ...
    },
    {
        ...
        category: "web",
        image: "assets/images/projects/Sistem Informasi Toko.png",
        description: "Proyek pengembangan sistem informasi untuk manajemen toko (mungkin tugas basis data atau PBW)."
    },
    {
        id: 4,
        title: "Analisis Data FMCG",
        category: "data",
        image: "assets/images/projects/Data FMCG.png",
        description: "Proyek analisis data FMCG menggunakan Excel. Menemukan insight: penjualan tertinggi terjadi pada bulan Desember (kenaikan 45%) dan penjualan terendah pada bulan Februari. Memberikan rekomendasi strategi untuk meningkatkan penjualan di bulan low season."
    },
    {
        id: 5,
        title: "Logo Produk Usaha",  // ← DESIGN
        category: "design",
        image: "assets/images/projects/Logo Produk Usaha.png",
        description: "Desain logo untuk produk usaha pribadi menggunakan Canva."
    },
    {
        id: 6,
        title: "UTS Portfolio Website",
        category: "web",
        image: "assets/images/projects/project uts.png",
        description: "Proyek UTS website portfolio profesional dengan fitur Dark Mode, filter portfolio, lightbox, form validasi, dan responsive design."
    }
];
...
function renderProjects(filter = 'all') {
    ...
    grid.innerHTML = filteredProjects.map(project => `
        <div class="portfolio-item" data-id="${project.id}">
            <img src="${project.image}" alt="${project.title}" class="portfolio-img" loading="lazy" onerror="this.src='https://placehold.co/600x400/e83e8c/white?text=Image+Not+Found'">
...
// Fungsi untuk mengisi progress bar dari data skill kamu
...
// Panggil loadProgressBars saat halaman dimuat
