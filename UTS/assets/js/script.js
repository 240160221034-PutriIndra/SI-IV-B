...
// ==========================================
// PORTOFOLIO DATA (6 Proyek) - SUDAH DIPERBAIKI
// ==========================================
const projects = [
...
function renderProjects(filter = 'all') {
    ...
    grid.innerHTML = filteredProjects.map(project => `
        <div class="portofolio-item" data-id="${project.id}">
            <img src="${project.image}" alt="${project.title}" class="portofolio-img" loading="lazy" onerror="this.src='https://placehold.co/600x400/e83e8c/white?text=Image+Not+Found'">
            <div class="portofolio-info">
                <h3>${project.title}</h3>
                <p>${project.description}</p>
                <span class="portofolio-category">${project.category}</span>
            </div>
        </div>
    `).join('');
